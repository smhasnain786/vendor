...
const Typing = () => {
    ...
    const TypingList = async () => {
        const result = await getAllTypingData()
    ...
    const fileFormmater = (cell, row) => {
        return <a href={imageUrl + row.file} target="_blank" rel="noreferrer" className="btn btn-primary">File</a>
    }
    const columns = [
                                    ...
                                    <div className="card-header">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            >
                                                ...
                                                <CSVLink className="dropdown-item" data={typingData}>
                                                    Export as CSV
                                                </CSVLink>
                                            </div>
                                        </div>
